...
'               DrawGradient from www.pscode.com submission "Let's talk about speed" by LiTe Templer
'
'           COMPILER SWITCHES:
'
'               bDebugStatistics    -   Exposes the Statistics sub - this value must match the same in pcGDIObjectStore.cls
